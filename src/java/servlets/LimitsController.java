 ...
 * @author Marck
 */
@WebServlet(name = "LimitsController", urlPatterns = {"/limits"})
public class LimitsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sl.isRole(regUser, "ADMIN")) {
            ...
            request.getRequestDispatcher(PageReturner.getPage("limits_admin"))
            ...
            List<LimitApp> limitApps = limitAppFacade.findAll();
            request.setAttribute("limitApps", limitApps);
            request.getRequestDispatcher(PageReturner.getPage("limits_master"))
                    .forward(request, response);
            return;
