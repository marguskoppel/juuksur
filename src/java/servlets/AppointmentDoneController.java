 ...
 * @author Marck
 */
@WebServlet(name = "AppointmentDoneController", urlPatterns = {
    "/appointmentdone",})
public class AppointmentDoneController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sl.isRole(regUser, "ADMIN")) {
            ...
            request.getRequestDispatcher(PageReturner.getPage("appointmentdone_admin"))
                    .forward(request, response);
            return;

        } else if (sl.isRole(regUser, "MASTER")) {

            request.getRequestDispatcher(PageReturner.getPage("appointmentdone_master"))
                    .forward(request, response);
            return;
