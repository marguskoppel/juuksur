 ...
 * @author Marck
 */
@WebServlet(name = "UserinfoeditController", urlPatterns = {
    "/userinfoedit",})
public class UserinfoeditController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sl.isRole(regUser, "ADMIN")) {
            ...
            request.getRequestDispatcher(PageReturner.getPage("userinfoedit_admin"))
                    .forward(request, response);
            return;
            ...
            request.getRequestDispatcher(PageReturner.getPage("userinfoedit_user"))
                    .forward(request, response);
            return;
            ...
            request.getRequestDispatcher(PageReturner.getPage("userinfoedit_master"))
                    .forward(request, response);
            return;
            ...
            User editUser = userFacade.find(new Long(eu));
            request.setAttribute("editUser", editUser);
            request.getRequestDispatcher(PageReturner.getPage("userinfoedit_worker"))
                    .forward(request, response);
            return;
