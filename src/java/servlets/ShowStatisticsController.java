 ...
 * @author Marck
 */
@WebServlet(name = "ShowStatisticsController", urlPatterns = {"/showStatistics"})
public class ShowStatisticsController extends HttpServlet {
@EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sl.isRole(regUser, "ADMIN")) {
            ...
            request.getRequestDispatcher(PageReturner.getPage("show_statistics_admin"))
                    .forward(request, response);
            return;
            ...
            request.setAttribute("listServices", listServices);
            request.setAttribute("listWorkers", listWorkers);
            request.getRequestDispatcher(PageReturner.getPage("show_statistics_master"))
                    .forward(request, response);
            return;
