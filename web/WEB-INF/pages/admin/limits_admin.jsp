...
<main class="page contact-us-page">
    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <form action="addnewlimit" method="POST">
                <div class="form-group"><label for="new-limit">Лимит(количество)</label><input class="form-control" size="65" type="number" name="newlimit" step="1" value="1" min="1" max="100" required="" /></div>
    ...
    <section class="clean-block clean-pricing dark">
        <div class="container">
            ...
            <table id="limits_admin" class="display table table-hover  table-striped" style="margin-bottom: 50px">
                ...
                <tbody>
                    <c:forEach var="limitApp" items="${limitApps}">
                        <tr>
                            ...
                            <td><a title='Изменить' href="editlimit?limit_id=${limitApp.id}"><button type="button" class="btn btn-outline-primary btn-sm"><i class="fas fa-edit"></i>Изменить</button></a> </td>
