    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            <div class="block-heading">
                <h2 class="text-info">Активация записей</h2>
                <p>Активируйте записи <a tabindex="0" data-toggle="popover" data-trigger="focus" title="Активация записей" data-html="true" data-content="Вы находитесь на странице активации записей.<br>Для <b>'активирования'</b> записи нажмите на кнопку <b>'Активировать'</b> у соответствующей записи в таблице."><i class="far fa-question-circle"></i></a></p>
                <p><b><i>${info} ${info2}</i></b></p>
                <a class="button btn btn-outline-primary"  href="appointments"><i class="far fa-arrow-alt-circle-left"></i>Активированные</a>

            </div>
            <div class="table-responsive">
                <table id="appointments_notactive_admin" class="display table table-hover table-striped">
                    ...
                    <tbody>
                        <c:forEach var="app" items="${appointmentsNotActive}">
                            <tr>
                                ...
                                <td><a title='Активировать' href="activateappointment?app_id=${app.id}"><i class="fas fa-power-off"></i></a></td>
                            </tr>
