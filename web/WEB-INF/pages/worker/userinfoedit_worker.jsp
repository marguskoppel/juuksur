    ...
    <section class="clean-block clean-form">
        <div class="container">
            ...
            <form action="editu?euId=${regUser.id}" method="POST">
                <div class="form-group"><input hidden name="${regUser.id}" value="${regUser.id}"><label for="user-name">Имя</label><input class="form-control item" type="text" name="name" id="user-name" value="${regUser.name}" required="" autofocus></div>
                ...
                <div class="form-group"><label for="user-email">Е-майл</label><input class="form-control item" type="email" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,6}" name="email"  value="${regUser.email}" required=""></div>
