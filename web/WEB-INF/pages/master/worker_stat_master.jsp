...
<main class="page contact-us-page">
    ...
    <section class="clean-block clean-form dark">
        <div class="container">
            ...
            <div class="block-heading">
                ...
                <p>Все выполненные услуги работника <a tabindex="0" data-toggle="popover" data-trigger="focus" title="Лимит на записи" data-html="true" data-content="Вы находитесь на странице статистики конкретного работника. <br><br>На странице представлены подсчеты выполненных услуг и оценки от клиентов для работника. "><i class="far fa-question-circle"></i></a></p>
                <p><b><i>${info} ${info2}</i></b></p>
                <a class="button btn btn-outline-success"  href="statistics"><i class="fas fa-backward"></i>Назад</a>
            </div>

            <div class="table-responsive">
                <table id="workerstat_master" class="display table table-hover table-striped">
    ...
    <section class="clean-block clean-form">
        <div class="container">
            ...
            <div class="table-responsive">
                <table id="workerstat_master2" class="display table table-hover table-striped">
                    <thead style="background-color: #5295dc;">
                        <tr>
                            <th scope="col">Услуги</th>
